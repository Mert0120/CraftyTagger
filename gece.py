  ...
  if event.is_private:
    async for usr in client.iter_participants(event.chat_id):
     ...
     await event.reply(f"{ad} {startmesaj}", buttons=(
                      ...
                      [Button.url('🌱 Məni Qrupa Əlavə Et', f'https://t.me/{swxtagger_bot}?startgroup=a')],
                     [Button.url('📣 Söhbət Qrupu', f'https://t.me/{SWXChatt}')],
                      [Button.url('ʀᴇsᴍᴊ Gurup', f'https://t.me/{SWXChatt}')],
...
async def handler(event):
    async for usr in client.iter_participants(event.chat_id):
     ...
     await event.edit(f"{ad} {startmesaj}", buttons=(
                      ...
                      [Button.url('⚕️ Məni Qrupa Əlavə Et', f'https://t.me/{swxtagger_bot}?startgroup=a')],
                     [Button.url('🇹🇷 Söhbət Qrupu', f'https://t.me/{SWXChatt}')],
...
print(">> Bot çalışmaktadur merak etme bot çalışıyor 🇹🇷 @SwoxyComeBack bilgi alabilirsin <<")
